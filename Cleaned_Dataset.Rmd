...
ggplot(main, aes(x = factor(health))) +
  ...
  labs(
    ...
    x = "Health Category (1 = Excellent, 5 = Poor)",
    y = "Count"
  ) +
  theme_minimal()
```
...
ggplot(main, aes(x = factor(impaired_stairs))) +
  ...
  theme_minimal()
#Visusalition: Bar plots- tiring tasks
ggplot(main, aes(x = factor(impaired_tiring_tasks))) +
  geom_bar(fill = "tomato", color = "black") +
  labs(
    title = "Distribution of Impaired Tiring Tasks",
    x = "Impairment in Tiring Tasks (1 = Impaired, 0 = Not Impaired)",
    y = "Count"
  ) +
  theme_minimal()
